<?php
   $width = isset($_GET['w']) ? $_GET['w'] : 956.6929133858267;
   $height = isset($_GET['h']) ? $_GET['h'] : 614.1732283464568;

   $width_foto = $width / 2.793103448275862;
   $height_foto = $height / 1.405405405405405;

   // $width_foto = isset($_GET['wf']) ? $_GET['wf'] : 342.5196850393701;
   // $height_foto = isset($_GET['hf']) ? $_GET['hf'] : 437.0078740157481;
   ...
   // echo $height_logo;
   $jarak_text = $height / 40.94488188976379;
   
   $font_1 = $height / ($height / 14);

   $h_15 = $height / 40.94488188976379;
   $h_30 = $height / 21.2666666667;

   $h_60 = $height / ($height / 60);
   $h_162 = $height / ($height / 162);
   $h_274 = $height / ($height / 274);
   $h_450 = $height / ($height / 450);
   
   $w_15 = $width / 63.77952755905511;
   $w_50 = $width / ($width / 50);
   $w_60 = $width / ($width / 60);
